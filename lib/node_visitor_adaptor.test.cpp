...
TESTCASE(jopp2_node_visitor_adaptor_dispatch_leaf_value_return_junk)
{
	...
	TestFwk::expect_death(
		...
		"jopp internal error: lib/./node_visitor_adaptor.hpp:209: Invalid return value from node visitor\n",
		SIGABRT
	);
}
...
TESTCASE(jopp2_node_visitor_adaptor_dispatch_leaf_value_array_return_junk)
{
	...
	TestFwk::expect_death(
		...
		"jopp internal error: lib/./node_visitor_adaptor.hpp:229: Invalid return value from node visitor\n",
		SIGABRT
	);
}
