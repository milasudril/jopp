...
TESTCASE(jopp2_updater_update_value)
{
	...
	auto const res4 = updater.update_with(some_l_value);
	...
	auto const res5 = updater.update_with(some_other_l_value);
	...
	auto const res6 = updater.update_with(yet_another_l_value);
	...
	auto const res7 = updater.update_with(long_array{'X'});
