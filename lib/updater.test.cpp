...
namespace
{
	...
	{
		THISCALL static void update(std::variant<std::string, int>& sink, jopp2::update_param_t<int> value)
		{ sink = value; }

		THISCALL static void update(std::variant<std::string, int>& sink, jopp2::update_param_t<std::string> value)
		{ sink = std::move(value); }
	};
}
