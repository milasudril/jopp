...
TESTCASE(jopp2_generic_value_update_traits_update_generic_value_bad_source)
{
	TestFwk::expect_death(
		...
		"jopp internal error: lib/./generic_value_update_traits.hpp:26: Cannot store the given value in a GenericValue\n",
		SIGABRT
	);
}
...
TESTCASE(jopp2_generic_value_update_traits_update_generic_value_source_is_key)
{
	TestFwk::expect_death(
		...
		"jopp internal error: lib/./generic_value_update_traits.hpp:37: Cannot store the given value in a GenericValue\n",
		SIGABRT
	);
}
